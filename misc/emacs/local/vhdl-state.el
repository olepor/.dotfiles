...
(define-key evil-vhdl-state-map "<escape>" 'evil-force-normal-state) ;; Not working
(define-key evil-vhdl-state-map "n" 'move-to-next-vhdl-object)
(define-key evil-vhdl-state-map "N" 'move-to-previous-vhdl-object)
